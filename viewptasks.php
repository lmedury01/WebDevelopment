	...
	<!--<div class="limiter">-->
      ...
      <div class="container">
        <div class="title">
          ...
          <h3><strong>View your Pending tasks here</strong></h3>
          <br>
          <a href="viewctasks.php" class="btn btn-twitter-bg btn-lg twitter-sharrre " rel="tooltip">
              View Completed Tasks
            </a> &nbsp;

            <a href="viewdtasks.php" class="btn btn-twitter-bg btn-lg twitter-sharrre " rel="tooltip">
              View Deleted Tasks
            </a>
        </div>
    	</div>
