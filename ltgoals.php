...
<nav class="navbar navbar-expand-lg fixed-top bg-info " color-on-scroll="300">
	...
	<!--<div class="limiter">-->
      ...
      <div class="container">
        <div class="title">
          ...
          <h3><strong>View your Long-term Goals here</strong></h3>
          <br>
          <a href="stgoals.php" class="btn btn-twitter-bg btn-lg twitter-sharrre " rel="tooltip">
					...
					<table>
						<thead>
						    ...
						    <th class="column2 text-center">Goals</th>
								<th class="column3 text-center">Difficulty</th>
	...
	<div style="font-weight: bold">
		<tr>
			...
			<td class="column3 text-center" style="font-weight:bold"><?php echo $rows['difficulty']; ?> </td>
		</tr>
	</div>
	<?php
	}
  ...
  <div class="row justify-content-md-center sharing-area text-center">
          ...
          <div class="text-center col-md-12 col-lg-8">
            ...
            <a href="addltgoals.php" class="btn btn-twitter-bg btn-lg twitter-sharrre btn-round" rel="tooltip" title="Tweet!">
              Add a goal
            </a>
