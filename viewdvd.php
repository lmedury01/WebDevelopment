...
<body class="index-page sidebar-collapse">
	...
	<!--<div class="limiter">-->
      ...
      <div class="container">
        <div class="title">
          <h1><strong>DVD</strong></h1>
          <h3><strong>View your DVD's here</strong></h3>
          </h3><br>
          <a href="viewbooks.php" class="btn btn-twitter-bg btn-lg twitter-sharrre " rel="tooltip">
              View Books
            </a>
        </div>
    	</div>
  ...
  <div class="row justify-content-md-center sharing-area text-center">
          ...
          <div class="text-center col-md-12 col-lg-8">
            ...
            <a href="adddvd.php" class="btn btn-twitter-bg btn-lg twitter-sharrre btn-round" rel="tooltip" title="Tweet!">
              Add a DVD
            </a>
