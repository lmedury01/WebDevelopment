...
<body class="index-page sidebar-collapse">
	...
	<!--<div class="limiter">-->
      ...
      <div class="container">
        <div class="title">
          ...
          <h3><strong>View your Weekly Activities here</strong></h3>
          <br>
  ...
  <div class="row justify-content-md-center sharing-area text-center">
          ...
          <div class="text-center col-md-12 col-lg-8">
            ...
            <a href="addwactivity.php" class="btn btn-twitter-bg btn-lg twitter-sharrre btn-round" rel="tooltip" title="Tweet!">
              Add an activity
            </a>
